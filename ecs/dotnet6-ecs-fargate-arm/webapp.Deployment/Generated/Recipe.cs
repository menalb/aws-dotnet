    ...
    public class Recipe : Construct
    {
        ...
        private void ConfigureAutoScaling(Configuration settings)
        {
            ...
            if (settings.AutoScaling.Enabled)
            {
                ...
                {
                    case webapp.Deployment.Configurations.AutoScalingConfiguration.ScalingTypeEnum.Cpu:
                        ...
                        break;
                    case webapp.Deployment.Configurations.AutoScalingConfiguration.ScalingTypeEnum.Memory:
                        ...
                        break;
                    case webapp.Deployment.Configurations.AutoScalingConfiguration.ScalingTypeEnum.Request:
